...
IMAGE_FOLDER_PATH = "C:/Users/truon/OneDrive/onenote/Wageningen UR _ Research_Work/Project_July_Nov_2024/Image_data_9_9_24/RGB"
LABELS_CSV_PATH = "C:/Users/truon/OneDrive/onenote/Wageningen UR _ Research_Work/Project_July_Nov_2024/Raw_data_9_9_24/labels_2c.csv"
IMAGE_SIZE = (224, 224)
...
# Restructured code for XGB classifier with VGG16
...
def create_xgb_model(data, labels, n_estimators=300):
    """
    Creates and trains a XGB model using k-fold cross-validation.
    """
    ...
    for train_index,val_index in kfold.split(data,labels):
        ...
        model = xgb.XGBClassifier(objective='binary:logistic',max_depth=5,gamma=0.2,
